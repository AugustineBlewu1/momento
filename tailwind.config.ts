...
const baseColors = {
  primaryDark: "#004D3F",   // Dark green
  primary: "#38A67E",       // Green
...
const generateThemeObject = (colors: any, mapping: any, invert = false) => {
  ...
  Object.keys(colors).forEach((color) => {
    ...
    Object.entries(mapping).forEach(([key, value]: any) => {
      ...
      theme[color][key] = colors[color];  // Assign the base color directly, ignoring shade
    });
  });
  return theme;
};
...
const themes = {
  ...
  dark: {
    ...darkTheme,
    white: baseColors.secondaryLight,
    black: baseColors.secondaryDark,
  },
};
